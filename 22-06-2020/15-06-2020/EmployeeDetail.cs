    ...
    public partial class EmployeeDetail : Form, IMyForm
    {
        ...
        public void ReloadData()
        {
            if (selectedEmployee != null) {
                //display to UI
                this.txtEmployeeName.Text = selectedEmployee.EmployeeName;
                this.txtTelephone.Text = selectedEmployee.Telephone;
            }
        }
        public void SetupUI()
        {
            ...
            Employee.employees = Database.SharedInstance().getAllEmployees(1);
        }
        ...
        private void ButtonAddNew_Click(object sender, EventArgs e)
        {
            ...
            if (Database.SharedInstance().insertEmployee(employee) == true)
            {
